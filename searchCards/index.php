...
<body>
  <div class="container">
    ...
    <button type="button" class="btn btn-info info" data-toggle="modal" data-target="#exampleModalCenter">Clique Aqui</button>
    <form class="form-inline my-2 my-lg-0" action="consulta.php">
